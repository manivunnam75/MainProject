    ...
    public class AdminViewController : Controller 
    {
        ...
        public ActionResult CreateBatch(BatchDetails batchdetails)
        {
            BatchDetails _batchDetails = new BatchDetails()
            {
                ...
                CourseAssigned=batchdetails.CourseAssigned
            };
        ...
        public ActionResult AllDetails1(int BatchId)
        {
            ...
            if(details!=null)
            {
                ...
                TempData["Course"] = details.CourseAssigned;
            }
            return RedirectToAction("AllTraineeDetails");
        }
        public ActionResult EveryBatchDetails(int BatchId)
        {
            ...
            if (details != null)
            {
                ...
                TempData["course"] = details2.CourseAssigned;
            }
                return View(details);
        ...
        public ActionResult EditBatch(BatchDetails batchDetails)
        {
           int batchid = 0;
            ...
            if (batchDetails != null)
            {
                ...
                sqlConnections.Query("update Traineeswithbatches set BatchId='"+_batchDetails.BatchId+ "',BatchName='"+_batchDetails.BatchName+ "',CourseAssigned='"+_batchDetails.CourseAssigned+ "' where BatchId='"+batchid+"'");
        ...
        public ActionResult SubBatch(int MainBatchId,string MainBatchName,int CourseAssigned)
        {
            TempData["btchid"] = MainBatchId;
            TempData["btchname"]=MainBatchName;
            TempData["btchcourse"]=CourseAssigned;
            return View();
        }
        ...
        public ActionResult CreateSubBatch(SubBatchesDetails subBatchDetails)
        {
           ...
           int courseAssigned = (int)TempData["btchcourse"];
        ...
        public ActionResult SubBatchesDetails()
        {
            if (TempData["MainBatchId"] != null)
            {
                ...
                TempData["courseAssigned"] = details2.CourseAssigned;
                return View(details);
        ...
        public ActionResult AddTraineeToSubBatch(int BatchId,string BatchName,int TraineeId,string TraineeName,int CourseAssigned,string SubBatchName)
        {
